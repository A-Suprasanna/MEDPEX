...
//             console.log("Rendering category: ", category); // Log each category
...
//     // Fetch products from the category-specific JSON file (e.g., medicaldrugs.json)
//     fetch("./assets/data/categories.json")
//         .then((response) => response.json())
//         .then((products) => {
...
//                     product.name.toLowerCase().includes(query) // Check if product name includes query
//                 );
